...
gulp.task("copies", function () {
	var streams = [
		...
		gulp.src(nodeRoot + "slicknav/dist/**/*").pipe(gulp.dest(targetPath + "/slicknav/dist")),
		gulp.src(nodeRoot + "owl.carousel/dist/**/*").pipe(gulp.dest(targetPath + "/owl.carousel/dist")),
		gulp.src(nodeRoot + "bootstrap-validator/dist/**/*").pipe(gulp.dest(targetPath + "/bootstrap-validator/dist")),
		gulp.src(nodeRoot + "summernote/dist/**/*").pipe(gulp.dest(targetPath + "/summernote/dist")),
		gulp.src(nodeRoot + "wowjs/dist/**/*").pipe(gulp.dest(targetPath + "/wowjs/dist")),
		gulp.src(nodeRoot + "jquery.counterup/**/*").pipe(gulp.dest(targetPath + "/jquery.counterup")),
		gulp.src(nodeRoot + "jquery.stellar/**/*").pipe(gulp.dest(targetPath + "/jquery.stellar")),
		gulp.src(nodeRoot + "waypoints/**/*").pipe(gulp.dest(targetPath + "/waypoints")),
