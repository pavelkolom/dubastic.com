...
namespace AdsMaster.DB.Migrations
{
    ...
    [Migration("20200711130235_InitialCreate")]
            ...
            modelBuilder.Entity("AdsMaster.DB.Models.SecurityLogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SecurityLogID = 1,
                            ActivityDate = new DateTime(2020, 7, 11, 17, 2, 34, 199, DateTimeKind.Local).AddTicks(7803),
                            IP = "",
                            Message = "",
                            SecurityLogType = 6,
                            TargetUserID = 1,
            ...
            modelBuilder.Entity("AdsMaster.DB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreationDate = new DateTime(2020, 7, 11, 17, 2, 34, 164, DateTimeKind.Local).AddTicks(1502),
