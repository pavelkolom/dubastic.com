 ...
 * Run commands:
 *    Add-Migration InitialCreate (do only one time and temporrary delete OnModelCreating())
...
namespace AdsMaster.DB.Models
{
    public class AdsMasterContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=18.156.26.156;Database=dubastic;User=popforumsadmin;Password=Kolopavs@1958");
        }
