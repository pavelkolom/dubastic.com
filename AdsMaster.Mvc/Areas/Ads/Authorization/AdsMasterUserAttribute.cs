...
{
	public class AdsMasterUserAttribute : IAuthorizationFilter, IActionFilter
	{
		...
		public void OnAuthorization(AuthorizationFilterContext context)
		{
			...
			var attributes = controllerActionDescriptor.MethodInfo.GetCustomAttributes(typeof(AdsMasterAuthorizationIgnoreAttribute), false);
			if (attributes.Any())
			{
				_ignore = true;
				return;
		...
		private bool IsValidToRunOnController(TypeInfo controllerType)
		{
			...
			return controllerNamespace != null && controllerNamespace.StartsWith("AdsMaster");
		}
	}
}